...
class News
{ 
	int newsId;String postedByUser;String commentByUser;String comment;News(int newsId,String postedByUser,String commentByUser,String comment)
{ 
		this.newsId=newsId;
...
public class NewsAssign {
    ...
    public static void main(String args[])
    {
        ...
        News news1 = new News(1, "Tanu", "ja", "comment");
        News news2 =new News(2, "Tanu1", "ja1", "budget");
        News news3 = new News(1, "Tanu2", "ja2", "comment");
        News news4 = new News(3, "Tanu3", "ja", "budget");
        News news5 = new News(1, "Tanu4", "ja2", "comment");
        News news6 = new News(3, "Tanu5", "ja", "budget");
        News news7 = new News(1, "Tanu6", "ja6" ,"comment");
